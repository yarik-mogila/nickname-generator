...
class NicknameGenerationFacadeTest {
    ...
    void shouldPassArgumentsToGenerator() {
        ...
        List<NicknameResult> results = facade.generate(3, NicknameLocale.RU, NicknameTemplate.NOUN_VERB, "123");
    ...
    void shouldUseNullSeedWhenBlank() {
        ...
        facade.generate(1, NicknameLocale.EN, NicknameTemplate.ADJ_NOUN, "   ");
    ...
    void shouldFailForInvalidSeed() {
        ...
        assertThrows(
                ...
                () -> facade.generate(1, NicknameLocale.EN, NicknameTemplate.ADJ_NOUN, "abc")
        );
    }
